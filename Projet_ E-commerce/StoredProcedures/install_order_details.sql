-- Execute this script to add the order details fetching stored procedure
-- AND update existing orders procedure
USE [cooperative]
GO

print 'Updating sp_get_orders_by_admin...';
GO
...
print 'Updating sp_get_order_items_admin...';
GO
